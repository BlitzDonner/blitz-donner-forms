...
class BDF_Captcha {
	...
	/**
	 * Einstellungen mit Defaults laden.
	 *
	...
	public static function verify( $token, $ip_address = '' ) {
		...
		if ( 200 === $code && is_array( $data ) ) {
			...
			return array(
				'result' => 'fail',
				'detail' => '' !== $err ? $err : 'response_invalid',
			);
		}
	...
	public static function privacy_text_snippet() {
		$paragraphs = array(
			__( 'Spam-Schutz durch Friendly Captcha', 'blitz-donner-forms' ),
			__( 'Wir setzen auf unseren Formularen den Dienst Friendly Captcha ein, einen Dienst der Friendly Captcha GmbH, Deutschland. [Firmenbezeichnung und Adresse]', 'blitz-donner-forms' ),
			__( 'Zweck. Friendly Captcha schützt unsere Formulare vor Spam und automatisiertem Missbrauch (etwa durch Bots).', 'blitz-donner-forms' ),
			__( 'Verarbeitete Daten. Verarbeitet werden Ihre IP-Adresse sowie technische Angaben Ihres Geräts, die für den Berechnungsnachweis (Proof-of-Work) nötig sind. Friendly Captcha setzt dabei keine Cookies, nutzt kein Fingerprinting und kein Tracking.', 'blitz-donner-forms' ),
			__( 'Funktionsweise. Statt Ihr Verhalten zu beobachten, lässt Friendly Captcha Ihren Browser im Hintergrund eine kleine Rechenaufgabe lösen (Proof-of-Work). Diese Aufgabe ist für Menschen unbemerkbar, für massenhaft automatisierte Anfragen aber aufwendig – so werden Bots ausgebremst, ohne dass Sie verfolgt werden.', 'blitz-donner-forms' ),
			__( 'Rechtsgrundlage. Die Verarbeitung stützt sich auf unser berechtigtes Interesse am Schutz unserer Formulare vor Missbrauch (Art. 6 Abs. 1 lit. f DSGVO; für die Schweiz Art. 31 revDSG).', 'blitz-donner-forms' ),
			__( 'Speicherort. Die Verarbeitung erfolgt auf Servern in der Europäischen Union. Eine Übermittlung in Drittländer findet nicht statt.', 'blitz-donner-forms' ),
			__( 'Auftragsverarbeitung. Mit der Friendly Captcha GmbH besteht ein Auftragsverarbeitungsvertrag nach Art. 28 DSGVO (bzw. Art. 9 revDSG).', 'blitz-donner-forms' ),
			__( 'Speicherdauer. Die Daten werden nur zur Verifikation der Anfrage verarbeitet und nicht zur Profilbildung genutzt. [Konkrete Speicherdauer aus der Dokumentation von Friendly Captcha]', 'blitz-donner-forms' ),
			__( 'Widerspruchsrecht. Sie haben das Recht, aus Gründen, die sich aus Ihrer besonderen Situation ergeben, jederzeit gegen diese auf berechtigtem Interesse beruhende Verarbeitung Widerspruch einzulegen (Art. 21 DSGVO).', 'blitz-donner-forms' ),
			__( 'Ihre Rechte. Ihnen stehen die Rechte auf Auskunft, Berichtigung und Löschung zu sowie ein Beschwerderecht bei der zuständigen Aufsichtsbehörde.', 'blitz-donner-forms' ),
			__( '(Unverbindliche Vorlage, keine Rechtsberatung. Bitte an Ihre konkrete Situation anpassen und im Zweifel rechtlich prüfen lassen.)', 'blitz-donner-forms' ),
		);
		return implode( "\n\n", $paragraphs );
	}
	...
	public static function lia_text_snippet() {
		$blocks = array(
			__( 'Interessenabwägung – Einsatz von Friendly Captcha', 'blitz-donner-forms' ),
			__( 'Internes Dokument zur Dokumentation des berechtigten Interesses (Art. 6 Abs. 1 lit. f DSGVO / Art. 31 revDSG).', 'blitz-donner-forms' ),
			__( '1. Zweck / berechtigtes Interesse', 'blitz-donner-forms' ) . "\n"
				. __( 'Wir schützen unsere Web-Formulare vor Spam und automatisiertem Missbrauch. Funktionierende Formulare ohne Bot-Flut sind die Grundlage für die Kommunikation mit unseren Besucherinnen und Besuchern.', 'blitz-donner-forms' ),
			__( '2. Erforderlichkeit / kein milderes Mittel', 'blitz-donner-forms' ) . "\n"
				. __( 'Reine serverseitige Massnahmen (Honeypot, Rate-Limit) fangen einfache Bots ab, aber nicht gezielten automatisierten Missbrauch. Ein Proof-of-Work-Captcha ohne Cookies und ohne Tracking ist das mildeste Mittel, das den Schutz spürbar erhöht, ohne das Verhalten der Besucher zu beobachten.', 'blitz-donner-forms' ),
			__( '3. Interessenabwägung', 'blitz-donner-forms' ) . "\n"
				. __( 'Der Eingriff ist gering: Verarbeitet wird allein die IP-Adresse, es findet kein Profiling statt, die Verarbeitung erfolgt in der EU und nur kurz zur Verifikation. Besucherinnen und Besucher erwarten, dass Formulare gegen Spam geschützt sind. Dem geringen Eingriff steht ein legitimer Schutzbedarf gegenüber. Die Interessen der Betroffenen überwiegen nicht.', 'blitz-donner-forms' ),
			__( '4. Ergebnis', 'blitz-donner-forms' ) . "\n"
				. __( 'Der Einsatz von Friendly Captcha auf berechtigtem Interesse ist zulässig.', 'blitz-donner-forms' ) . "\n"
				. __( 'Datum: [TT.MM.JJJJ]', 'blitz-donner-forms' ) . "\n"
				. __( 'Verantwortliche Person: [Name / Funktion]', 'blitz-donner-forms' ),
			__( '(Unverbindliche Vorlage, keine Rechtsberatung. Bitte an Ihre konkrete Situation anpassen und im Zweifel rechtlich prüfen lassen.)', 'blitz-donner-forms' ),
		);
		return implode( "\n\n", $blocks );
	}
